	...
	<div class="container">
	  <div class="row">
	    ...
	    <div class="col-5">
	    	...
	    	<h5 class="texto-form-juegos mb-4 text-center">Añadir permisos nuevos</h5>  
			    <form action="crear_perfil_menu" method="post" class="form-group">
				     ...
				     <button type="submit" class="btn btn-outline-light btn-juegos mt-4">Añadir Permisos</button>
				 </form>  
	    	</div>
	    </div>
	    <div class="col-6">
