    ...
    $(document).ready(function() {
    	<c:forEach items="${listaCuestionarios}" var="cuest">
    		...
    		if(typeof col !== "undefined" && typeof row !== "undefined")
    		{
    			...
    			console.log($("#tablaCuest").find('tr').eq(row));
    			console.log($("#tablaCuest").find('tr').eq(row).find('td').eq(col));
    			console.log($("#tablaCuest").find('tr').eq(row).find('td').eq(col).children());
	  ...
	  <div class="row">
	    ...
	    <div class="col-8">
	    	<div style="text-align: center">
			    ...
			    <table id="tablaCuest" class="table table-bordered">
				  <tr>
				  	<td class="d-none">-</td>
				  	<td class="d-none">-</td>
				  	<td class="d-none">-</td>
